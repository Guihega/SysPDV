...
else
{
  ...
  else
  {
    ...
    <!--Contenido-->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box-tools pull-right btnAcciones">
                  <button class="btn btn-sm btn-success" id="btnagregar" onclick="mostrarform(true,0)"><i class="fa fa-plus-circle"></i> Agregar</button>
      ...
      <!--Fin-Contenido-->
      <!-- Modal -->
      <div class="modal fade" id="modalNuevoIngreso" aria-modal="true">
                  ...
                  <div class="col-md-12">
                    <div class="form-group col-lg-6 col-md-6 col-sm-3 col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button class="btn btn-default" id="btnAgregarProveedor" type="button" data-toggle="modal" data-target="#modalNuevoProveedor"><i class="fa fa-plus"></i></button>
                        </span>
                      </div>
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button class="btn btn-default" id="btnAgregarCliente" type="button" data-toggle="modal" data-target="#modalNuevoComprobante"><i class="fa fa-plus"></i></button>
                        </span>
                      </div>
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
...
<!--                       <div class="input-group">
                    ...
                    <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                      <thead style="background-color:#A9D0F5">
                        ...
                        <tfoot>
                            ...
                            <th></th>
                            <th></th>
                            <th><span id="simboloMoneda"><?php echo $_SESSION['simbolo'].' '?></span><label id="total"> 0.00</label><input type="hidden" name="total_compra" id="total_compra"></th> 
                        </tfoot>
                    </table>
                  </div>
                </div>
      ...
      <!-- Fin modal -->
        ...
        <!-- Modal -->
      <div class="modal fade" id="modalNuevoProveedor" aria-modal="true">
        <form name="formulario" id="formularioProveedor" method="POST">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-footer">
                  <button id="btnGuardarProveedor" class="btn btn-sm btn-primary" type="submit"><i class="fa fa-save"></i> Guardar</button>
                  <button id="btnCancelarProveedor" class="btn btn-sm btn-danger" data-dismiss="modal" type="button"><i class="fa fa-arrow-circle-left"></i> Cancelar</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
