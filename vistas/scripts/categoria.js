	...
	$.ajax({
	    ...
	    {                    
			...
			if (datos == 0) {
	    		...
	    		icono = 'error';
	    		mensaje = 'La categoría no se pudo registrar';
	    	}
	    	else if (datos == 2){
	    		icono = 'success';
...
function mostrar(idcategoria)
{
	$.post("../ajax/categoria.php?op=mostrar",{idcategoria : idcategoria}, function(data, status)
	{
		...
		$(".modal-title").html('Editar Categoría ' + idcategoria);
			  	...
			  	$.ajax({
			        ...
			        success: function(response) {
			            if (response == 0) {
				    		...
				    		icono = 'error';
				    		mensaje = 'La categoría no se puede desactivar';
				    	}
			  	...
			  	$.ajax({
			        ...
			        success: function(response) {
			            if (response == 0) {
				    		...
				    		icono = 'error';
				    		mensaje = 'La categoría no se puede activar';
				    	}
